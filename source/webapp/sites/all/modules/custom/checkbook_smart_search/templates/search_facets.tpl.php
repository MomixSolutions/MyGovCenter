...
//Begin of Narrow down search by Agency
    ...
    if(count($agencies) > 0){
        ...
        $output .= "<th colspan='3'>By Public Service</th>";
        $i=0;
        $displayRows = NULL;
        $hiddenRows = NULL;
        ...
        if($i > 5){
            $output .= "<div style='margin-bottom: 20px'><a href=\"javascript:toggleDisplay('hiddenagencies');changeLinkText('showmorelinkAg','Public Services')\">
                        <div id='showmorelinkAg'>Show more Public Services &#187</div></a></div>";
        }
    }
