...
<div class="home_totals_links">
 ...
 //     $link = RequestUtil::preparePayrollBottomNavFilter("spending_landing",null);
      $link = "spending_landing/yeartype/B/year/115?expandBottomCont=true";
      $dollars = "<span class='dollars'>" . custom_number_formatter_format($total,1,'$') . "</span>";      
      ?>
        <div class="positioning">
      <?php if($total != 0 ){?>        
          <a href="/<?php echo $link; ?>"><?php echo $count; ?>Total Spending To Date<br>Current Fiscal Year<br><?php echo $dollars; ?>
          <span class="div-link"></span>
          </a>
        <?php }else{?>
        <?php echo $count; ?>Total Spending To Date<br>Current Fiscal Year<br><?php echo $dollars; ?>
        <?php }?>           
        </div>
</div>
