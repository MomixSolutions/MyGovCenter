    ...
    if(count($node->data) > 0){
        ...
        foreach($node->data as $data){
          ...
          $output .= "<div class='title'>Narrow down your search:</div><div class='content clearfix'>";
			...
			$output .= "<thead><tr><th colspan='3'>By Public Service</th></tr></thead>";
			...
			if(count($agencies) > 5){
				...
				$output .= "<div class='nd-more-link'><a href=\"javascript:toggleDisplay('hiddenagencies');changeLinkText('showmorelinkAg','Public Services')\"><div id='showmorelinkAg'>Show more Public Services &#187;</div></a></div>";
