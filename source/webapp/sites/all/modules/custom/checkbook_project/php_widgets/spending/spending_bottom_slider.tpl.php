    ...
    <tr>
      ...
      <td<?php echo $class; ?>>
        ...
        <?php if($dollars_by_cat[1] != 0 ){?>
          <a href="/<?php echo $link; ?>?expandBottomCont=true"><?php echo $count; ?>Operational<br>Spending<br><?php echo $dollars; ?></a>
        <?php }else{?>
        <?php echo $count; ?>Operational<br>Spending<br><?php echo $dollars; ?>
        <?php }?>            
        </div>
        <div class="indicator"></div>
      </td>
      ...
      <?php if($dollars_by_cat[5] != 0 ){?>                
          <a href="/<?php echo $link; ?>?expandBottomCont=true"><?php echo $count; ?>Debt<br>Spending<br><?php echo $dollars; ?></a>
        <?php }else{?>
        <?php echo $count; ?>Debt<br>Spending<br><?php echo $dollars; ?>
        <?php }?>           
        </div>
        <div class="indicator"></div>
      </td>
